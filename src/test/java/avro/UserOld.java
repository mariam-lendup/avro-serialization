...
@AvroGenerated
public class UserOld extends SpecificRecordBase implements SpecificRecord {
  ...
  private static final BinaryMessageEncoder<UserOld> ENCODER = new BinaryMessageEncoder<UserOld>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<UserOld> DECODER =
      new BinaryMessageDecoder<UserOld>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<UserOld> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<UserOld> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<UserOld>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public UserOld(CharSequence name, Integer favorite_number, CharSequence favorite_color) {
    this.name = name;
   ...
   */
  public static UserOld.Builder newBuilder() {
    return new UserOld.Builder();
  }
   ...
   * @return A new User RecordBuilder
   */
  public static Builder newBuilder(UserOld.Builder other) {
   ...
   * @return A new User RecordBuilder
   */
  public static Builder newBuilder(UserOld other) {
    return new Builder(other);
  }
   ...
   */
  public static class Builder extends SpecificRecordBuilderBase<UserOld>
    implements RecordBuilder<UserOld> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(UserOld.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public UserOld.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserOld.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserOld.Builder setFavoriteColor(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserOld.Builder clearFavoriteColor() {
      favorite_color = null;
  ...
  @SuppressWarnings("unchecked")
  private static final DatumWriter<UserOld>
    WRITER$ = (DatumWriter<UserOld>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final DatumReader<UserOld>
    READER$ = (DatumReader<UserOld>)MODEL$.createDatumReader(SCHEMA$);
